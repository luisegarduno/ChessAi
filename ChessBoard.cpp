...
*/
  ...
  if(DEBUGS){
    std::vector<std::vector<int>> nSquaresToEdge(64);
    ...
    for(int x = 0; x < 64; x++){
      int n = nSquaresToEdge[x][0], s = nSquaresToEdge[x][1], w = nSquaresToEdge[x][2], e = nSquaresToEdge[x][3], nw = nSquaresToEdge[x][4], se = nSquaresToEdge[x][5], ne = nSquaresToEdge[x][6], sw = nSquaresToEdge[x][7];
